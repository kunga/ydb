...
Y_UNIT_TEST_SUITE(TLegacy) {
    ...
    Y_UNIT_TEST(IndexIter) {
                ...
                std::vector<ui64>& sizes)
        {
            ...
            TStringBuilder log;
            TStatsScreenedPartIterator idxIter(TPartView{part, nullptr, nullptr}, &env, scheme->Keys, nullptr, nullptr, 0, 0, log);
            sizes.clear();
    ...
    Y_UNIT_TEST(ScreenedIndexIter) {
        ...
        auto fnIterate = [&dbgOut, &typeRegistry] (TIntrusiveConstPtr<TPartStore> part, TIntrusiveConstPtr<TScreen> screen,
            ...
            TTestEnv env;
            TStringBuilder log;
            TStatsScreenedPartIterator idxIter(TPartView{part, screen, nullptr}, &env, scheme->Keys, std::move(frames), nullptr, 0, 0, log);
    ...
    Y_UNIT_TEST(StatsIter) {
        ...
        {
            TStringBuilder log;
            auto it1 = MakeHolder<TStatsScreenedPartIterator>(TPartView{eggs2.At(0), screen2, nullptr}, &env, lay2.RowScheme()->Keys, nullptr, nullptr, 0, 0, log);
            auto it2 = MakeHolder<TStatsScreenedPartIterator>(TPartView{eggs1.At(0), screen1, nullptr}, &env, lay2.RowScheme()->Keys, nullptr, nullptr, 0, 0, log);
